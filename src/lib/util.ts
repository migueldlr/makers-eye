...
// Full identity name to faction mapping from NetrunnerDB API
const FULL_ID_TO_FACTION: Record<string, string> = {
  ...
  "BANGUN: When Disaster Strikes": "Weyland",
  'Barry "Baz" Wong: Tri-Maf Veteran': "Criminal",
  "Blue Sun: Powering the Future": "Weyland",
  'Boris "Syfr" Kovac: Crafty Veteran': "Criminal",
  "Captain Padma Isbister: Intrepid Explorer": "Shaper",
  "Cerebral Imaging: Infinite Frontiers": "HB",
  "Chaos Theory: Wünderkind": "Shaper",
  "Chronos Protocol: Selective Mind-mapping": "Jinteki",
  "Custom Biotics: Engineered for Success": "HB",
  "Cyber Bureau: Keeping the Peace": "_Neutral",
  "Cybernetics Division: Humanity Upgraded": "HB",
  "Dewi Subrotoputri: Pedagogical Dhalang": "Shaper",
  "Earth Station: SEA Headquarters": "Weyland",
  ...
  "Fringe Applications: Tomorrow, Today": "Weyland",
  "Gabriel Santiago: Consummate Professional": "Criminal",
  "Gagarin Deep Space: Expanding the Horizon": "Weyland",
  "GameNET: Where Dreams are Real": "NBN",
  "GRNDL: Power Unleashed": "Weyland",
  "Haarpsichord Studios: Entertainment Unleashed": "NBN",
  "Haas-Bioroid: Architects of Tomorrow": "HB",
  "Haas-Bioroid: Engineering the Future": "HB",
  "Haas-Bioroid: Precision Design": "HB",
  "Haas-Bioroid: Stronger Together": "HB",
  ...
  "Jemison Astronautics: Sacrifice. Audacity. Success.": "Weyland",
  ...
  "LEO Construction: Labor Solutions": "HB",
  ...
  "MirrorMorph: Endless Iteration": "HB",
  ...
  "Seidr Laboratories: Destiny Defined": "HB",
  "Silhouette: Stealth Operative": "Criminal",
  "Skorpios Defense Systems: Persuasive Power": "Weyland",
  "Spark Agency: Worldswide Reach": "NBN",
  "Sportsmetal: Go Big or Go Home": "HB",
  "SSO Industries: Fueling Innovation": "Weyland",
  "Steve Cambridge: Master Grifter": "Criminal",
  "Strategic Innovations: Future Forward": "HB",
  "Sunny Lebeau: Security Specialist": "Sunny",
  ...
  "The Catalyst: Convention Breaker": "_Neutral",
  "The Foundry: Refining the Process": "HB",
  "The Masque: Cyber General": "_Neutral",
  "The Outfit: Family Owned and Operated": "Weyland",
  "The Professor: Keeper of Knowledge": "Shaper",
  "The Shadow: Pulling the Strings": "_Neutral",
  "The Syndicate: Profit over Principle": "_Neutral",
  "The Zwicky Group: Invisible Hands": "Weyland",
  "Thule Subsea: Safety Below": "HB",
  "Thunderbolt Armaments: Peace Through Power": "HB",
  "Titan Transnational: Investing In Your Future": "Weyland",
  "Topan: Ormas Leader": "Anarch",
  "Valencia Estevez: The Angel of Cayambe": "Anarch",
  "Weyland Consortium: Because We Built It": "Weyland",
  "Weyland Consortium: Builder of Nations": "Weyland",
  "Weyland Consortium: Building a Better World": "Weyland",
  "Weyland Consortium: Built to Last": "Weyland",
...
export const idToFaction = (id?: string | null) => {
  ...
  // Check full identity name first, then shortened name
  if (id in FULL_ID_TO_FACTION) {
    return FULL_ID_TO_FACTION[id];
  }
